...
namespace :sample do
  ...
  task register: :environment do
    ...
    chips = Food.create(name: 'ポテトチップス',
                        amount: 3,
                        expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                        box: box,
                        unit: pack,
                        created_user: user,
                        updated_user: user)
    chocolates = Food.create(name: 'チョコ',
                             amount: 3,
                             expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                             box: box,
                             unit: ko,
  ...
  task create: :environment do
    ...
    carrots = Food.create(name: 'にんじん',
                          ...
                          created_user: mother,
                          updated_user: mother)
    cabbages = Food.create(name: 'キャベツ',
                           amount: 3,
                           expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                           box: cold,
                           unit: ko,
                           created_user: mother,
                           updated_user: mother)
    potatos = Food.create(name: 'じゃがいも',
                          amount: 3,
                          expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                          box: cold,
                          unit: ko,
    ...
    eggs = Food.create(name: 'たまご',
                       ...
                       created_user: mother,
                       updated_user: mother)
    icecreaem = Food.create(name: 'アイスクリーム',
                            amount: 3,
                            expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                            box: frozen,
                            unit: ko,
    ...
    rice = Food.create(name: '冷凍ごはん',
                       ...
                       created_user: mother,
                       updated_user: mother)
    mix_vege = Food.create(name: '冷凍ミックスベジタブル',
                           amount: 3,
                           expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                           box: frozen,
                           unit: pack,
    ...
    nimono = Food.create(name: '肉じゃが',
                         ...
                         created_user: grandma,
                         updated_user: grandma)
    miso_soup = Food.create(name: 'みそ汁',
                            amount: 3,
                            expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                            box: cooked,
                            unit: shoku,
                            created_user: grandma,
                            updated_user: grandma)
    croquette = Food.create(name: 'コロッケ',
                            amount: 3,
                            expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                            box: cooked,
                            unit: ko,
                            created_user: grandma,
                            updated_user: grandma)
    pan_cake = Food.create(name: 'ホットケーキ',
                           amount: 3,
                           expiration_date: Random.rand(tomorrow..tomorrow.next_month),
                           box: cooked,
                           unit: ko,
